...
class ControllerUserUserPermission extends Controller {
	...
	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($user_group_total) ? (($page - 1) * 20) + 1 : 0, ((($page - 1) * 20) > ($user_group_total - 20)) ? $user_group_total : ((($page - 1) * 20) + 20), $user_group_total, ceil($user_group_total / 20));
