...
class ControllerToolErrorLog extends Controller {
	...
	public function clear() {
		...
		if (!$this->user->hasPermission('modify', 'tool/error_log')) {
			...
			$syslogger->write('[WARN ][Permission ][MODULE: ERROR LOG FILE ][CLEAR FILE ] | USER: ['.$this->user->getId().']['.$user_info['username'].'] '.$user_info['firstname'].' '.$user_info['lastname']);
			...
			$syslogger->write('[INFO ][MODULE: ERROR LOG FILE ][CLEAR FILE ] | USER: ['.$this->user->getId().']['.$user_info['username'].'] '.$user_info['firstname'].' '.$user_info['lastname']);
