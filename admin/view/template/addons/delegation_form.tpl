						...
						<div class="row">	
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="libelle_delegation" value="<?php echo $libelle_delegation; ?>" placeholder="<?php echo $entry_title; ?>" id="input-username">
									<?php if ($error_title) { ?>
						...
						<div class="row">	
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="gouvernoat" id="input-status" class="form-control">
