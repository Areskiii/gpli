						...
						<tbody>		
							...
							<tr>
								<td class="text-center"><?php if (in_array($Gouvernorat['id'], $selected)) { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Gouvernorat['id']; ?>" checked="checked" />
									<?php } else { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Gouvernorat['id']; ?>" />
									<?php } ?>
								</td>
								<td class="text-left"><?php echo $Gouvernorat['Libelle']; ?></td>
								<td class="text-left"><?php echo $Gouvernorat['Etat']; ?></td>
								<td class="text-right">
									<a href="<?php echo $Gouvernorat['edit']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_edit; ?>">
