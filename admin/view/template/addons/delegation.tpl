					...
					<div class="content table-responsive table-full-width">
						...
						<thead>
							<tr>
								...
								<th class="text-left"><?php if ($sort == 'libelle_delegation') { ?>
						...
						<tbody>		
							...
							<tr>
								<td class="text-center"><?php if (in_array($Delegation['id'], $selected)) { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Delegation['id']; ?>" checked="checked" />
									<?php } else { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Delegation['id']; ?>" />
									<?php } ?>
								</td>
								<td class="text-left"><?php echo $Delegation['Libelle']; ?></td>
								<td class="text-left"><?php echo $Delegation['Gouvernorat']; ?></td>
								<td class="text-left"><?php echo $Delegation['Etat']; ?></td>
								<td class="text-right">
									<a href="<?php echo $Delegation['edit']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_edit; ?>">
