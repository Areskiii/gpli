					...
					<div class="content table-responsive table-full-width">
						<table class="table">
							...
							<tbody>
								...
								<tr>
								  <td class="text-center"><?php if (in_array($user['personnel_id'], $selected)) { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $user['personnel_id']; ?>" checked="checked" />
									<?php } else { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $user['personnel_id']; ?>" />
									<?php } ?></td>
