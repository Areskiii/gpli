					...
					<div class="content table-responsive table-full-width">
						...
						<thead>
							<tr>
								...
								<th class="text-left"><?php if ($sort == 'type_matriel') { ?>
									<a href="<?php echo $sort_type_matriel; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_type_matriel; ?></a>
									<?php } else { ?>
									<a href="<?php echo $sort_type_matriel; ?>"><?php echo $column_type_matriel; ?></a>
									<?php } ?></th>
								<th class="text-left"><?php if ($sort == 'marque_matriel') { ?>
									<a href="<?php echo $sort_marque_matriel; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_marque_matriel; ?></a>
									<?php } else { ?>
									<a href="<?php echo $sort_marque_matriel; ?>"><?php echo $column_marque_matriel; ?></a>
									<?php } ?></th>									
						...
						<tbody>		
							...
							<tr>
								...
								<td class="text-left"><?php echo $Matriel['site']; ?></td>
								<td class="text-left"><?php echo $Matriel['bureau']; ?></td>
								<td class="text-left"><?php echo $Matriel['type_matriel']; ?></td>	
								<td class="text-left"><?php echo $Matriel['marque_matriel']; ?></td>
								<td class="text-right">
