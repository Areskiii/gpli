						...
						<thead>
							<tr>
								...
								<th class="text-left"><?php if ($sort == 'title') { ?>
									...
									<?php } ?></th>
								<th class="text-left"><?php if ($sort == 'title') { ?>
									<a href="<?php echo $sort_title; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_gouvernorat; ?></a>
									<?php } else { ?>
									<a href="<?php echo $sort_title; ?>"><?php echo $column_gouvernorat; ?></a>
									<?php } ?></th>	
								<th class="text-left"><?php if ($sort == 'title') { ?>
						...
						<tbody>		
							...
							<tr>
								<td class="text-center"><?php if (in_array($Article['id'], $selected)) { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Matriel['id']; ?>" checked="checked" />
									<?php } else { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Matriel['id']; ?>" />
									<?php } ?>
								</td>
								<td class="text-left"><?php echo $Matriel['Libelle']; ?></td>
								<td class="text-left"><?php echo $Matriel['Gouvernorat']; ?></td>
								<td class="text-left"><?php echo $Matriel['Code']; ?></td>
								<td class="text-left"><?php echo $Matriel['Etat']; ?></td>
								<td class="text-right">
									<a href="<?php echo $Matriel['details']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_details; ?>">
										<i class="fa fa-search" style="font-size: 25px;"></i>
									</a>
									<a href="<?php echo $Matriel['matriel']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_matriel; ?>">
										<i class="fa fa-laptop" style="font-size: 25px;"></i>
									</a>
									<a href="<?php echo $Matriel['personnel']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_personnel; ?>">
										<i class="fa fa-user" style="font-size: 25px;"></i>
									</a>
									<a href="<?php echo $Matriel['edit']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_edit; ?>">
