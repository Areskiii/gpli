					...
					<div class="content table-responsive table-full-width">
						...
						<tbody>		
							...
							<tr>
								...
								<td class="text-right">
									<a href="<?php echo $Site['matriel']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_matriel; ?>">
										<i class="fa fa-laptop" style="font-size: 25px;"></i>
									</a>
									<a href="<?php echo $Site['personnel']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_personnel; ?>">
