					...
					<div class="content table-responsive table-full-width">
						...
						<thead>
							<tr>
								...
								<th class="text-left"><?php if ($sort == 'libelle_marque_matriel') { ?>
						...
						<tbody>		
							...
							<tr>
								<td class="text-center"><?php if (in_array($Marque['id'], $selected)) { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Marque['id']; ?>" checked="checked" />
									<?php } else { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Marque['id']; ?>" />
									<?php } ?>
								</td>
								<td class="text-left"><?php echo $Marque['Libelle']; ?></td>
								<td class="text-left"><?php echo $Marque['type_Matriel']; ?></td>
								<td class="text-left"><?php echo $Marque['Etat']; ?></td>
								<td class="text-right">
									<a href="<?php echo $Marque['edit']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_edit; ?>">
